...
public class DemoPlayerController : HierarchicalStateMachine<DemoPlayerStateFactory>
{
    /// <summary>
    ...
    protected override void SetupHierarchicalStateMachine()
    {
        _stateFactory = new DemoPlayerStateFactory(this, this);
    ...
    public PlayerStats StatsInstance
    {
        get => _statsInstance;
    ...
    public HierarchicalBaseState<DemoPlayerStateFactory> CurrentState1
    {
        get => _currentState;
