...
public class PixelatedCamera : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        int width = mode == PixelScrenMode.Resize ? (int)targetScreenSize.width : _screenWidth / (int)screenScaleFactor;
        int height = mode == PixelScrenMode.Resize
