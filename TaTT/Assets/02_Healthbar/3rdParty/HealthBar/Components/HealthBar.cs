...
public class HealthBar : MonoBehaviour
{
    ...
    [Header("Fill")] [SerializeField] Gradient _lowToHighHealthTransition;

    [Header("Wave")] [SerializeField, Range(0, 0.1f)]
    float _fillWaveAmplitude;
    ...
    [Header("Border")] [SerializeField, Range(0, 0.15f)]
    float _borderWidth;
    ...
    public float HealthNormalized
    {
        ...
        set
        {
            ...
            _matInstance.SetFloat("_healthNormalized", value);
