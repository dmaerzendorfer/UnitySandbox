...
public class ProceduralEye : MonoBehaviour
{
    ...
    {
        get { return slope(verts[0], verts[1]); }
    }

    public float topCenter
    {
        get { return (verts[0].y + verts[1].y) * 0.5f; }
    }

    public float topMax
    {
        get { return Mathf.Max(verts[0].y, verts[1].y); }
    }

    public float topMin
    {
        get { return Mathf.Min(verts[0].y, verts[1].y); }
    }

    public float botSlope
    {
        get { return slope(verts[2], verts[3]); }
    }

    public float botCenter
    {
        get { return (verts[2].y + verts[3].y) * 0.5f; }
    }

    public float botMax
    {
        get { return Mathf.Max(verts[2].y, verts[3].y); }
    }

    public float botMin
    {
        get { return Mathf.Min(verts[2].y, verts[3].y); }
    }
